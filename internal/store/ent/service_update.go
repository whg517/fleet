...
func (_u *ServiceUpdate) AddDeploymentIDs(ids ...string) *ServiceUpdate {
...
func (_u *ServiceUpdate) AddConfigSnapshotIDs(ids ...string) *ServiceUpdate {
	_u.mutation.AddConfigSnapshotIDs(ids...)
	return _u
}

// AddConfigSnapshots adds the "config_snapshots" edges to the ConfigSnapshot entity.
func (_u *ServiceUpdate) AddConfigSnapshots(v ...*ConfigSnapshot) *ServiceUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ServiceUpdate) AddApprovalIDs(ids ...string) *ServiceUpdate {
	_u.mutation.AddApprovalIDs(ids...)
	return _u
}

// AddApprovals adds the "approvals" edges to the Approval entity.
func (_u *ServiceUpdate) AddApprovals(v ...*Approval) *ServiceUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ServiceUpdate) RemoveDeploymentIDs(ids ...string) *ServiceUpdate {
...
func (_u *ServiceUpdate) ClearConfigSnapshots() *ServiceUpdate {
...
func (_u *ServiceUpdate) RemoveConfigSnapshotIDs(ids ...string) *ServiceUpdate {
	_u.mutation.RemoveConfigSnapshotIDs(ids...)
	return _u
}

// RemoveConfigSnapshots removes "config_snapshots" edges to ConfigSnapshot entities.
func (_u *ServiceUpdate) RemoveConfigSnapshots(v ...*ConfigSnapshot) *ServiceUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *ServiceUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ApprovalsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.ApprovalsTable,
			Columns: []string{service.ApprovalsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddDeploymentIDs adds the "deployments" edge to the Deployment entity by IDs.
func (_u *ServiceUpdateOne) AddDeploymentIDs(ids ...string) *ServiceUpdateOne {
	_u.mutation.AddDeploymentIDs(ids...)
	return _u
}
...
// AddConfigSnapshotIDs adds the "config_snapshots" edge to the ConfigSnapshot entity by IDs.
func (_u *ServiceUpdateOne) AddConfigSnapshotIDs(ids ...string) *ServiceUpdateOne {
	_u.mutation.AddConfigSnapshotIDs(ids...)
	return _u
}

// AddConfigSnapshots adds the "config_snapshots" edges to the ConfigSnapshot entity.
func (_u *ServiceUpdateOne) AddConfigSnapshots(v ...*ConfigSnapshot) *ServiceUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddApprovalIDs adds the "approvals" edge to the Approval entity by IDs.
func (_u *ServiceUpdateOne) AddApprovalIDs(ids ...string) *ServiceUpdateOne {
	_u.mutation.AddApprovalIDs(ids...)
	return _u
}

// AddApprovals adds the "approvals" edges to the Approval entity.
func (_u *ServiceUpdateOne) AddApprovals(v ...*Approval) *ServiceUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveDeploymentIDs removes the "deployments" edge to Deployment entities by IDs.
func (_u *ServiceUpdateOne) RemoveDeploymentIDs(ids ...string) *ServiceUpdateOne {
	_u.mutation.RemoveDeploymentIDs(ids...)
	return _u
}
...
// ClearConfigSnapshots clears all "config_snapshots" edges to the ConfigSnapshot entity.
func (_u *ServiceUpdateOne) ClearConfigSnapshots() *ServiceUpdateOne {
	_u.mutation.ClearConfigSnapshots()
	return _u
}

// RemoveConfigSnapshotIDs removes the "config_snapshots" edge to ConfigSnapshot entities by IDs.
func (_u *ServiceUpdateOne) RemoveConfigSnapshotIDs(ids ...string) *ServiceUpdateOne {
	_u.mutation.RemoveConfigSnapshotIDs(ids...)
	return _u
}

// RemoveConfigSnapshots removes "config_snapshots" edges to ConfigSnapshot entities.
func (_u *ServiceUpdateOne) RemoveConfigSnapshots(v ...*ConfigSnapshot) *ServiceUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearApprovals clears all "approvals" edges to the Approval entity.
func (_u *ServiceUpdateOne) ClearApprovals() *ServiceUpdateOne {
	_u.mutation.ClearApprovals()
	return _u
}

// RemoveApprovalIDs removes the "approvals" edge to Approval entities by IDs.
func (_u *ServiceUpdateOne) RemoveApprovalIDs(ids ...string) *ServiceUpdateOne {
	_u.mutation.RemoveApprovalIDs(ids...)
	return _u
}

// RemoveApprovals removes "approvals" edges to Approval entities.
func (_u *ServiceUpdateOne) RemoveApprovals(v ...*Approval) *ServiceUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
