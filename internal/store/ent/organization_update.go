...
func (_u *OrganizationUpdate) AddDeploymentIDs(ids ...string) *OrganizationUpdate {
	_u.mutation.AddDeploymentIDs(ids...)
	return _u
}

// AddDeployments adds the "deployments" edges to the Deployment entity.
func (_u *OrganizationUpdate) AddDeployments(v ...*Deployment) *OrganizationUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) AddConfigSnapshotIDs(ids ...string) *OrganizationUpdate {
	_u.mutation.AddConfigSnapshotIDs(ids...)
	return _u
}

// AddConfigSnapshots adds the "config_snapshots" edges to the ConfigSnapshot entity.
func (_u *OrganizationUpdate) AddConfigSnapshots(v ...*ConfigSnapshot) *OrganizationUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearDeployments() *OrganizationUpdate {
	_u.mutation.ClearDeployments()
	return _u
}

// RemoveDeploymentIDs removes the "deployments" edge to Deployment entities by IDs.
func (_u *OrganizationUpdate) RemoveDeploymentIDs(ids ...string) *OrganizationUpdate {
	_u.mutation.RemoveDeploymentIDs(ids...)
	return _u
}

// RemoveDeployments removes "deployments" edges to Deployment entities.
func (_u *OrganizationUpdate) RemoveDeployments(v ...*Deployment) *OrganizationUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) ClearConfigSnapshots() *OrganizationUpdate {
...
func (_u *OrganizationUpdate) RemoveConfigSnapshotIDs(ids ...string) *OrganizationUpdate {
	_u.mutation.RemoveConfigSnapshotIDs(ids...)
	return _u
}

// RemoveConfigSnapshots removes "config_snapshots" edges to ConfigSnapshot entities.
func (_u *OrganizationUpdate) RemoveConfigSnapshots(v ...*ConfigSnapshot) *OrganizationUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *OrganizationUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.DeploymentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.DeploymentsTable,
			Columns: []string{organization.DeploymentsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.ConfigSnapshotsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   organization.ConfigSnapshotsTable,
			Columns: []string{organization.ConfigSnapshotsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddDeploymentIDs adds the "deployments" edge to the Deployment entity by IDs.
func (_u *OrganizationUpdateOne) AddDeploymentIDs(ids ...string) *OrganizationUpdateOne {
	_u.mutation.AddDeploymentIDs(ids...)
	return _u
}

// AddDeployments adds the "deployments" edges to the Deployment entity.
func (_u *OrganizationUpdateOne) AddDeployments(v ...*Deployment) *OrganizationUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddConfigSnapshotIDs adds the "config_snapshots" edge to the ConfigSnapshot entity by IDs.
func (_u *OrganizationUpdateOne) AddConfigSnapshotIDs(ids ...string) *OrganizationUpdateOne {
	_u.mutation.AddConfigSnapshotIDs(ids...)
	return _u
}

// AddConfigSnapshots adds the "config_snapshots" edges to the ConfigSnapshot entity.
func (_u *OrganizationUpdateOne) AddConfigSnapshots(v ...*ConfigSnapshot) *OrganizationUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearDeployments clears all "deployments" edges to the Deployment entity.
func (_u *OrganizationUpdateOne) ClearDeployments() *OrganizationUpdateOne {
	_u.mutation.ClearDeployments()
	return _u
}

// RemoveDeploymentIDs removes the "deployments" edge to Deployment entities by IDs.
func (_u *OrganizationUpdateOne) RemoveDeploymentIDs(ids ...string) *OrganizationUpdateOne {
	_u.mutation.RemoveDeploymentIDs(ids...)
	return _u
}

// RemoveDeployments removes "deployments" edges to Deployment entities.
func (_u *OrganizationUpdateOne) RemoveDeployments(v ...*Deployment) *OrganizationUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearConfigSnapshots clears all "config_snapshots" edges to the ConfigSnapshot entity.
func (_u *OrganizationUpdateOne) ClearConfigSnapshots() *OrganizationUpdateOne {
	_u.mutation.ClearConfigSnapshots()
	return _u
}

// RemoveConfigSnapshotIDs removes the "config_snapshots" edge to ConfigSnapshot entities by IDs.
func (_u *OrganizationUpdateOne) RemoveConfigSnapshotIDs(ids ...string) *OrganizationUpdateOne {
	_u.mutation.RemoveConfigSnapshotIDs(ids...)
	return _u
}

// RemoveConfigSnapshots removes "config_snapshots" edges to ConfigSnapshot entities.
func (_u *OrganizationUpdateOne) RemoveConfigSnapshots(v ...*ConfigSnapshot) *OrganizationUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
