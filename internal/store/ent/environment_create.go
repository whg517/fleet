...
func (_c *EnvironmentCreate) AddConfigSnapshotIDs(ids ...string) *EnvironmentCreate {
	_c.mutation.AddConfigSnapshotIDs(ids...)
	return _c
}

// AddConfigSnapshots adds the "config_snapshots" edges to the ConfigSnapshot entity.
func (_c *EnvironmentCreate) AddConfigSnapshots(v ...*ConfigSnapshot) *EnvironmentCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *EnvironmentCreate) AddApprovalIDs(ids ...string) *EnvironmentCreate {
	_c.mutation.AddApprovalIDs(ids...)
	return _c
}

// AddApprovals adds the "approvals" edges to the Approval entity.
func (_c *EnvironmentCreate) AddApprovals(v ...*Approval) *EnvironmentCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
