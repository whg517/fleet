...
func HasClusters() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasClustersWith(preds ...predicate.Cluster) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasEnvironments() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEnvironmentsWith(preds ...predicate.Environment) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasDeployments() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasDeploymentsWith(preds ...predicate.Deployment) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasConfigSnapshots() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasConfigSnapshotsWith(preds ...predicate.ConfigSnapshot) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasApprovals() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasApprovalsWith(preds ...predicate.Approval) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
